...
INSERT INTO `curso` VALUES (13,'AUto Judicial',1,0,'AUto Judicial'),(14,'Aviones',1,0,'Aviones'),(15,'Sistemas Operativos',5,0,'Analizar la estructura interna de los sistemas operativos para el ANÃ?LISIS, DiseÃ±o e implementacion de sistemas computacionales  '),(16,'Ingles',5,0,'we will learn English\r\n'),(17,'Teoria Computacional',7,0,'En este curso estudiaremos los principios de los lenguajes formales y a los automatas.'),(18,'Logica',7,0,'En este curso veremos los fundamentos de la Logica');
...
INSERT INTO `examen` VALUES (1,0,3,23,'2018-05-24 05:48:58'),(2,0,6,29,'2018-06-03 01:11:40'),(3,0,6,31,'2018-06-03 02:03:48');
...
INSERT INTO `pregunta` VALUES (1,29,'Â¿Un sistema operativos es programa que actua intermediario entre _______ y la computadora?','Usuario','Hardaware','Software','Internet'),(1,31,'The festival, Â­Â­Â­Â­Â­Â­Â­Â­Â­Â­Â­______________ lasted all day, ended with a banquet.','which','who','that','where'),(2,29,'El principal Proposito de un sistema operativo es:','Proporcionar un entorno para que el usuario pueda ejecutar programas ','La seguridad e integridad de la computadora','Controlar todo el Hardware','cOMUNICAR SOFTWARE CON HARDWARE'),(2,31,'I am looking for someone __________ can watch my dog while I go on vacation.','who','that','which','what'),(3,29,'Â¿Proporcionar interfaz de lÃ­nea de comando o una interfaz grÃ¡fica al usuario ES UNA TAREA PRINCIPAL DEL so?','Si ','no ','Solo la interfaz de la linea de comandos ','Solo la interfaz GRÃ?FICA '),(3,31,'The police needed details _____________ could help identify the robber.','that','whatever','which','what'),(4,29,'Â¿eS UNA TAREA PRINCIPAL DE UN SISTEMA OPERATIVO?','Administrar los dispositivos de hardware en la computadora. El Sistema Operativo sirve de intermediario entre los programas y el hardware.','Encargarse de la tramas recibidas de internet','Proteger la informacion del usuario','ninguna de las anteriores '),(4,31,'I’d like to take you to a café _______________ serves excellent coffee.','which','whatever','whow','what'),(5,29,'Es una caracteristica de un sistema operativo:','Eficiencia','Robustes','Seguridad','Ninguna de las anteriores'),(5,31,'The clubhouse, in __________ the dance was held, housed about 200 people.','which','whatever','whow','what'),(6,29,'¿A que se refiere la habilidad para evolucionar',' Un Sistema Operativo deberá construirse de manera que permita el desarrollo, prueba o introducción efectiva de nuevas funciones del sistema sin interferir con el servicio.','El Sistema Operativo se encarga de manejar de una mejor manera los recursos de la computadora en cuanto a hardware se refiere.','Un Sistema Operativo debe hacerle fácil al usuario el acceso y manejo de los dispositivos de Entrada/ Salida de la computadora.','ninguna de las anteriores'),(6,31,'You can choose one person, __________ you like, to share the cruise with you.','Whomever','that','whow','what'),(7,29,'¿que es lo primero que hace la computadora al encenderse? ',' llevar a cabo un autodiagnóstico llamado auto prueba de encendido','Cargar el sistema operativo','conectarse a la red','examinar el disco duro'),(7,31,'I saw the shoes __________ you bought last week on sale for less this week.','that','where','whow','what'),(8,29,'Defincion informal de sistema operativo','Es un programa encargado de controlar todos los elementos de una computadora','Es el primer software que corre sobre una computadora','Es un software de base encargado de administrar cada uno de los componentes de un equipo de computo de manera rapida y eficiente','ninguna de las anteriores'),(8,31,'The winners, __________ known, will receive money and other prizes','when','where','whow','what'),(9,29,'Defincion formal de sistema operativo','Es un software de base encargado de administrar cada uno de los componentes de un equipo de computo de manera rapida y eficiente','Es el primer software que corre sobre una computadora','Es un programa encargado de controlar todos los elementos de una computadora','ninguna de las anteriores'),(9,31,'This is the place __________ we met.','when','where','whow','what'),(10,29,'El sistema operativo es un software de: ','Base','Tiempo Real','Aplicacion','Driver'),(10,31,'The baby, ________ nap had been interrupted, wailed loudly.','whose','where','whow','what'),(11,29,'¿Un sistema operativo esta compuesto por un conjunto de administradores?','Si','No','Solo es uno ','esta compuesto por un conjunto de protocolos'),(11,31,'Yeah, I have a friend________ is a writer, and he uses them all the time ','that','where','whow','what');
...
INSERT INTO `publicacion` VALUES (1,13,4,'Increible!',NULL,1);
...
INSERT INTO `usuariocurso` VALUES (13,3),(16,3),(13,4),(15,6),(16,6);
...
-- Dump completed on 2018-06-03 17:21:45
